...
public class Donate extends AppCompatActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, com.google.android.gms.location.LocationListener {
    ...
    EditText mFullName,mFoodItem,mDescription,mPhone,mFoodQty;
    TextInputLayout errorQty;
    Spinner mFoodIType;
    Button mSubmitBtn;
    FirebaseAuth fAuth;
    ...
    String[] arrFoodType = {"Raw Food","Processed"};
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //added
        mFoodIType = (Spinner) findViewById(R.id.foodType);
        mFoodQty = findViewById(R.id.foodQty);
        errorQty = findViewById(R.id.errorQty);
    ...
    private void initSpinner() {
        ArrayAdapter adapter = new ArrayAdapter(this, android.R.layout.simple_spinner_item,arrFoodType);
        adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        mFoodIType.setPrompt("Food Type");
        mFoodIType.setAdapter(adapter);
        mFoodIType.setSelection(0);
        mFoodIType.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> adapterView, View view, int position, long l) {
                if (position==0){
                    errorQty.setHint("Food Qty (kg)");
                }else {
                    errorQty.setHint("Food Qty (person)");
                }
            }
    ...
    public void onLocationChanged(@NonNull Location location) {
        ...
        mSubmitBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String type= "Donor";
                String foodType = arrFoodType[mFoodIType.getSelectedItemPosition()];
                String foodQty = mFoodQty.getText().toString();

                if(TextUtils.isEmpty(foodQty))
                {
                    mFullName.setError("Qty is Required.");
                    return;
                }
                ...
                user.put("type",type);
                //added
                user.put("foodType",foodType);
                user.put("foodQty",foodQty);
